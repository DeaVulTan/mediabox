...
CHMOD the "importer" folder to 777
...
CHMOD the "upload" folder to 777 (this only applies if you bought complete set or the Outlook importer)
...
For help on CHMOD please visit : http://www.siteground.com/tutorials/ftp/ftp_chmod.htm
