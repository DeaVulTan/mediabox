...
require_once DIR_PEAR . 'Spreadsheet/Excel/Writer/Format.php';
require_once DIR_PEAR . 'Spreadsheet/Excel/Writer/BIFFwriter.php';
require_once DIR_PEAR . 'Spreadsheet/Excel/Writer/Worksheet.php';
require_once DIR_PEAR . 'Spreadsheet/Excel/Writer/Parser.php';
require_once DIR_PEAR . 'OLE/PPS/Root.php';
require_once DIR_PEAR . 'OLE/PPS/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
        include_once DIR_PEAR . 'Spreadsheet/Excel/Writer/Validator.php';
