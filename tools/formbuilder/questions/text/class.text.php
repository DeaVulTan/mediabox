	...
	class Text extends Question 
	{
		...
		public function getUpdateHTML($id = null)
		{
			...
			if(($info = $this->getSetting($id)) !== false)
			{
				...
				return getQuestionUpdateTplHTML($id, $info['question'], '<input style="' . (!empty($info['width'])?'width:' . intval($info['width']) . 'px;':'')  . '" type="text" class="fireFormInput" id="fireFormField' . $id . '" value="' . $info['default_value'] . '" name="' . $info['id'] . '">', $info['instruction']); 
		...
		{
			return getQAddHTML(TEXT_BTN_ADD, $this->getType());
		}		
		...
		public function getHTML($id = null)
		{
			...
			if(($info = $this->getSetting($id)) !== false)
			{
				...
				return getQuestionTplHTML($id, $info['question'], '<input style="' . (!empty($info['width'])?'width:' . intval($info['width']) . 'px;':'')  . '" type="text" class="fireFormInput" id="fireFormField' . $id . '" value="' . $info['default_value'] . '" name="' . $info['id'] . '">', $info['instruction']); 
