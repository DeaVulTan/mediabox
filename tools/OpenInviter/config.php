<?php
	$openinviter_settings=array(
		"username"=>"volume",
		"private_key"=>"7c6439777b0eb94d60f2dda34fabdd07",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to Rayzz Framework", // Rayzz Framework is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to Rayzz Framework", // Rayzz Framework is the website on your account. If wrong, please update your account at OpenInviter.com
