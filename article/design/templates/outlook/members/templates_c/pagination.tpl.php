<?php /* Smarty version 2.6.18, created on 2012-02-01 20:17:51
	...
	<ul>
		...
		<?php if ($this->_tpl_vars['smarty_paging_list']['previous']['start']): ?>
			<li class="clsPrevLinkPage">
                <span>
                    <a href="<?php echo $this->_tpl_vars['smarty_paging_list']['first']['href']; ?>
...
"><?php echo $this->_tpl_vars['smarty_paging_list']['first']['display_text']; ?>
		...
		<?php if ($this->_tpl_vars['smarty_paging_list']['first']['start']): ?>
			<li class="clsFirstPageLink">
                <span>
                    <a href="<?php echo $this->_tpl_vars['smarty_paging_list']['previous']['href']; ?>
...
?>
			<?php if ($this->_tpl_vars['smarty_paging_list']['list']['start'][$this->_tpl_vars['key']]): ?>
				<li class="clsPagingLink">
                   <span>
                       <a href="<?php echo $this->_tpl_vars['smarty_paging_list']['list']['href'][$this->_tpl_vars['key']]; ?>
...
"><?php echo $this->_tpl_vars['smarty_paging_list']['list']['display_text'][$this->_tpl_vars['key']]; ?>
		...
		<?php if ($this->_tpl_vars['smarty_paging_list']['last']['start']): ?>
			<li class="clsLastPageLink">
                <span>
                    <a href="<?php echo $this->_tpl_vars['smarty_paging_list']['next']['href']; ?>
...
"><?php echo $this->_tpl_vars['smarty_paging_list']['next']['display_text']; ?>
		...
		<?php if ($this->_tpl_vars['smarty_paging_list']['next']['start']): ?>
			<li class="clsNextPageLink">
                <span>
                    <a href="<?php echo $this->_tpl_vars['smarty_paging_list']['last']['href']; ?>
