...
function replaceShareMusicEmailFriend(email_address_value, email_friends)
	{
		...
		if(email_friends.checked)
			{
				if(!email_address_value)
					{
						email_address_value = replaceShareMusicEmailFriend(email_address_value, email_friends);
		...
		if(typeof(view_music_music_ajax_page_loading) != 'undefined')
			{
				if(view_music_music_ajax_page_loading)
					{
						$Jq('#share_submitted').html(view_music_music_ajax_page_loading);
