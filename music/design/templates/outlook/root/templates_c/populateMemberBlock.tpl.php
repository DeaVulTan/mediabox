<?php /* Smarty version 2.6.18, created on 2012-02-03 21:30:02
     ...
     <div class="clsAudioIndex clsCategoryHd clsIndexMyMusicContainer">
            ...
            <ul class="clsOverflow" >
              <?php $this->assign('css_temp', ''); ?>
                ...
                <?php /*?><li class="<?php echo $this->_tpl_vars['myobj']->getMusicNavClass('left_musicuploadpopup'); ?>
...
"><?php echo $this->_tpl_vars['LANG']['sidebar_manage_artist_link_label']; ?>
                    	...
                    	<?php endif; ?>
                                ...
                                <?php if (isAllowedMusicUpload ( )): ?>
                                <?php /*?><li class="<?php if ($this->_tpl_vars['myobj']->_currentPage == 'musicalbummanage'): ?>
...
"><?php echo $this->_tpl_vars['LANG']['sidebar_viewing_histry_label']; ?>
                  ...
                  <!--music upload default setting by ahmedov abror-->
						<?php /*?> <li class="<?php echo $this->_tpl_vars['myobj']->getMusicNavClass('left_musicdefaultsettings'); ?>
...
"><?php echo $this->_tpl_vars['LANG']['sidebar_music_default_settings_label']; ?>
                  ...
                  <!--music upload default setting by ahmedov abror end-->
