<?php /* Smarty version 2.6.18, created on 2014-02-17 23:44:21
         compiled from managePlaylistComments.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'smartyTabIndex', 'managePlaylistComments.tpl', 20, false),)), $this); ?>
 ...
 ?>
    <div class="clsOverflow">
      <div class="clsHeadingLeft">
        <h2><span><span><?php echo $this->_tpl_vars['myobj']->form_manage_comments['comments_title']; ?>
</span></h2>
      </div>
...
" onchange="return changeCommentStatus(this.value)">
								<option value="" <?php if ($this->_tpl_vars['myobj']->getFormField('comment_status') == ''): ?>Selected<?php endif; ?>><?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_selectbox_all']; ?>
</option>
								<option value="<?php echo $this->_tpl_vars['LANG']['common_yes_option']; ?>
" <?php if ($this->_tpl_vars['myobj']->getFormField('comment_status') == $this->_tpl_vars['LANG']['common_yes_option']): ?>Selected<?php endif; ?>><?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_activate']; ?>
</option>
								<option value="<?php echo $this->_tpl_vars['LANG']['common_no_option']; ?>
" <?php if ($this->_tpl_vars['myobj']->getFormField('comment_status') == $this->_tpl_vars['LANG']['common_no_option']): ?>Selected<?php endif; ?>><?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_inactivate']; ?>
</option>
							</select>
				</form>
        </div>
...
" class="clsMyMusicAlbumTbl">
						  <tr>
							...
							<th class="clsWidth90"><?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_by']; ?>
</th>
							<th class="clsWidth75"><?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_date']; ?>
</th>
							<th class="clsWidth55"><?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_status']; ?>
</th>
							<th><?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_option']; ?>
</th>
						  </tr>
...
"><?php echo $this->_tpl_vars['value']['user_details']; ?>
                                  ...
                                  <?php if ($this->_tpl_vars['value']['comment_status'] == 'Yes'): ?>
                                   	<?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_activate']; ?>

                                  <?php elseif ($this->_tpl_vars['value']['comment_status'] == 'No'): ?>
                                  	<?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_inactivate']; ?>
						...
						<table style="border-bottom:0; margin-bottom:0;">
						  <tr>
                            <td style="padding:0">
								...
								<div class="clsCancelButton-l"><span class="clsCancelButton-r"><input type="button" class="clsSubmitButton" name="delete_submit" id="delete_submit" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" value="<?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_delete']; ?>
" onClick="if(getMultiCheckBoxValue('commendsForm', 'check_all', '<?php echo $this->_tpl_vars['LANG']['common_check_atleast_one']; ?>
', 'dAltMulti', -100, -500))Confirmation('selMsgConfirm', 'confirm_form', Array('comment_id','act', 'selConfirmMsg'), Array(multiCheckValue, 'delete', '<?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_delete_confirmation']; ?>
'), Array('value','value', 'innerHTML'), 0, 0);" /></span></div>
																	<div class="clsSubmitButton-l"><span class="clsSubmitButton-r"><input type="button" class="clsSubmitButton" name="activate" id="activate" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" value="<?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_activate_button_label']; ?>
" onClick="if(getMultiCheckBoxValue('commendsForm', 'check_all', '<?php echo $this->_tpl_vars['LANG']['common_check_atleast_one']; ?>
', 'dAltMulti', -100, -500))Confirmation('selMsgConfirm', 'confirm_form', Array('comment_id','act', 'selConfirmMsg'), Array(multiCheckValue, 'activate', '<?php echo $this->_tpl_vars['LANG']['manageplaylistcomments_activate_confirmation']; ?>
