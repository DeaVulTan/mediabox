<?php /* Smarty version 2.6.18, created on 2013-08-12 09:15:50
...
unset($_smarty_tpl_vars);
 ?>
	 <div class="clsAudioIndex"><h3 class="clsH3Heading"><?php echo $this->_tpl_vars['LANG']['profileblog_title']; ?>
</h3></div>
...
"><?php echo $this->_tpl_vars['LANG']['profileblog_add_new_blog']; ?>
             ...
             <div class="clsProfileBlogHdRight"> 
              <?php if ($this->_tpl_vars['myobj']->getFormField('music_id') != ''): ?>
                    <p>
                        <a href="<?php echo $this->_tpl_vars['myobj']->view_music_url; ?>
