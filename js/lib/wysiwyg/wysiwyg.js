//
// openWYSIWYG v1.01 Copyright (c) 2008 openWebWare.com
...
\* ---------------------------------------------------------------------- */
wysiwygDir = cfg_site_url+"js/lib/wysiwyg/";
// Images Directory
imagesDir = wysiwygDir+"icons/";

// CSS Directory
cssDir = wysiwygDir+"styles/";

// Popups Directory
popupsDir = wysiwygDir+"popups/";
...
function generate_wysiwyg(textareaID) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '\n'
  + '<iframe frameborder="0" id="wysiwyg' + n + '" class="clsRichTextEditorIframe"></iframe>\n'
  + '\n';
