...
Control.ScrollBar = Class.create({
    initialize: function(container,track,options){
        ...
        this.track = $(track);
        //Added by shankar for hiding/showing the scrollbar image accordingly
		if($('scrollbar_container'))
			this.scrollbar_container = $('scrollbar_container');
		else if($('create_slide_scrollbar_container'))
			this.scrollbar_container = $('create_slide_scrollbar_container');
    ...
    enable: function(){
        ...
        this.track.show();
        //Added by shankar for hiding/showing the scrollbar image accordingly
		this.scrollbar_container.removeClassName('clsNoScroll');
    ...
    disable: function(){
        ...
        this.track.hide();
        //Added by shankar for hiding/showing the scrollbar image accordingly
		this.scrollbar_container.addClassName('clsNoScroll');
        if(this.options.active_class_name)
