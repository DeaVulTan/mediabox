...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		document.writeln('<table class="clsContentIframeTable"><tr><td><iframe class="clsContentIframe" onload="rteLoad(this);" id="' + rte + '" name="' + rte + '" width="' + width + '" height="' + height + 'px" src="' + includesPath + 'blank.htm"></iframe></td></tr></table>');
		if (!readOnly) document.writeln('<br /><input type="checkbox" class="clsCheckRadio" id="chkSrc' + rte + '" onclick="toggleHTMLSrc(\'' + rte + '\');" />&nbsp;View Source');
		document.writeln('<iframe class="clsPaletteIframe" width="154" height="104" id="cp' + rte + '" src="'+palette_url+'" marginwidth="0" marginheight="0" scrolling="no" style="visibility:hidden; position: absolute;"></iframe>');
