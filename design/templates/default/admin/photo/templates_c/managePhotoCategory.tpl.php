<?php /* Smarty version 2.6.18, created on 2011-10-26 11:37:29
         compiled from managePhotoCategory.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'smartyTabIndex', 'managePhotoCategory.tpl', 9, false),)), $this); ?>
<div id="selmanagephotocategory">
  	<h2><span><?php echo $this->_tpl_vars['LANG']['managephotocategory_title']; ?>
</span></h2>
...
">
			<table summary="<?php echo $this->_tpl_vars['LANG']['managephotocategory_confirm_tbl_summary']; ?>
">
				<tr>
					<td>
...
" autocomplete="off">
            	<table class="clsNoBorder" summary="<?php echo $this->_tpl_vars['LANG']['managephotocategory_create_tbl_summary']; ?>
">
                	<tr>
...
<label for="category"><?php echo $this->_tpl_vars['LANG']['managephotocategory_category_name']; ?>
</label>
                    	</td>
                        <td class="<?php echo $this->_tpl_vars['myobj']->getCSSFormFieldCellClass('category'); ?>
">
                            <p><input type="text" class="clsTextBox" maxlength="<?php echo $this->_tpl_vars['CFG']['admin']['photos']['category_accept_max_length']; ?>
...
">
                           <label for="category_image"><?php echo $this->_tpl_vars['LANG']['managephotocategory_category_image']; ?>
</label><br />
                           (<?php echo $this->_tpl_vars['myobj']->imageFormat; ?>
) &nbsp;<?php echo $this->_tpl_vars['CFG']['admin']['photos']['category_image_max_size']; ?>
 KB
                        </td>
...
" />
                           ...
                           <?php if ($this->_tpl_vars['myobj']->getFormField('category_id') && $this->_tpl_vars['myobj']->getFormField('photo_category_ext') != ''): ?>
                                <img src="<?php echo $this->_tpl_vars['myobj']->category_image; ?>
" alt="<?php echo $this->_tpl_vars['myobj']->getFormField('category_image'); ?>
" /><br/>
                                <a href="javascript:void(0);" onclick="return Confirmation('selMsgConfirm', 'msgConfirmform',Array('action', 'confirmMessage'), Array('delete_category_image', '<?php echo $this->_tpl_vars['LANG']['managephotocategory_image_delete_confirmation']; ?>
'), Array('value', 'innerHTML'), -100, -500);"><?php echo $this->_tpl_vars['LANG']['managephotocategory_image_delete']; ?>
</a>
                           <?php endif; ?>
                           <?php if ($this->_tpl_vars['myobj']->getFormField('photo_category_ext') == '' && $this->_tpl_vars['myobj']->getFormField('category_id')): ?>
...
">
                            <?php echo $this->_tpl_vars['myobj']->displayCompulsoryIcon(); ?>
<label for="category_description"><?php echo $this->_tpl_vars['LANG']['managephotocategory_category_description']; ?>
</label>
                        </td>
...
"><label for="allow_post1"><?php echo $this->_tpl_vars['LANG']['managephotocategory_allow_post']; ?>
</label></td>
...
"><label for="photo_category_type1"><?php echo $this->_tpl_vars['LANG']['managephotocategory_photo_category_type']; ?>
</label></td>
                        <td class="<?php echo $this->_tpl_vars['myobj']->getCSSFormFieldCellClass('photo_category_type'); ?>
">
                            <input type="radio" class="clsCheckRadio" name="photo_category_type" id="photo_category_type1" value="Porn" tabindex="<?php echo smartyTabIndex(array(), $this);?>
"<?php echo $this->_tpl_vars['myobj']->isCheckedRadio('photo_category_type','Porn'); ?>
 />&nbsp;<label for="photo_category_type1" ><?php echo $this->_tpl_vars['LANG']['porn']; ?>
</label>&nbsp;&nbsp;
                            <input type="radio" class="clsCheckRadio" name="photo_category_type" id="photo_category_type2" value="General" tabindex="<?php echo smartyTabIndex(array(), $this);?>
"<?php echo $this->_tpl_vars['myobj']->isCheckedRadio('photo_category_type','General'); ?>
/>&nbsp;<label for="photo_category_type2"><?php echo $this->_tpl_vars['LANG']['general']; ?>
</label></td>
                            <p><?php echo $this->_tpl_vars['myobj']->getFormFieldErrorTip('photo_category_type'); ?>
</p>
                    </tr>
					<?php endif; ?>
...
">
                            <label for="status_yes"><?php echo $this->_tpl_vars['LANG']['managephotocategory_category_status']; ?>
</label>
                        </td>
...
" />&nbsp;<label for="status_yes"><?php echo $this->_tpl_vars['LANG']['managephotocategory_status_yes']; ?>
</label>&nbsp;&nbsp;
...
" />&nbsp;<label for="status_no"><?php echo $this->_tpl_vars['LANG']['managephotocategory_status_no']; ?>
</label>
                        </td>
                    </tr>
                    <tr>
...
">
                            <label for="priority"><?php echo $this->_tpl_vars['LANG']['managephotocategory_priority']; ?>
</label>
                      </td>
...
" value="<?php echo $this->_tpl_vars['LANG']['managephotocategory_update_submit']; ?>
" />
...
" value="<?php echo $this->_tpl_vars['LANG']['managephotocategory_cancel_submit']; ?>
" />
                    <?php else: ?>
                            <input type="submit" class="clsSubmitButton" name="category_submit" id="category_submit" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" value="<?php echo $this->_tpl_vars['LANG']['managephotocategory_add_submit']; ?>
" />
                    <?php endif; ?></td>
                    </tr>
                </table>
...
unset($_smarty_tpl_vars);
 ?>
                <?php endif; ?>
                <table summary="<?php echo $this->_tpl_vars['LANG']['managephotocategory_tbl_summary']; ?>
">
                    <tr>
...
" onClick="CheckAll(document.selFormCategory.name, document.selFormCategory.check_all.name)"/></th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_category_id']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_category']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_category_type']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_photo_count']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_description']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_allow_post']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_status']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_date_added']; ?>
</th>
                        <th>&nbsp;</th>
                    </tr>
...
?>
                    <tr>
                        <td class="clsAlignCenter"><input type="checkbox" class="clsCheckRadio" name="category_ids[]" value="<?php echo $this->_tpl_vars['scValue']['record']['photo_category_id']; ?>
" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" <?php echo $this->_tpl_vars['scValue']['checked']; ?>
 onClick="checkCheckBox(this.form, 'check_all');"/>
                        </td>
                        <td><?php echo $this->_tpl_vars['scValue']['record']['photo_category_id']; ?>
</td>
                        <td>
                            <p id="categoryName"><?php echo $this->_tpl_vars['scValue']['record']['photo_category_name']; ?>
</p>

                        </td>
                        <td><?php echo $this->_tpl_vars['scValue']['record']['photo_category_type']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['myobj']->getPhotoCount($this->_tpl_vars['scValue']['record']['photo_category_id']); ?>
</td>

                        <td><?php echo $this->_tpl_vars['scValue']['record']['photo_category_description']; ?>
</td>
                        <td><?php echo $this->_tpl_vars['scValue']['record']['allow_post']; ?>
</td>
                        <td>
                            <p><?php echo $this->_tpl_vars['scValue']['record']['photo_category_status']; ?>
</p>
                        </td>
                        <td>
                        ...
                        <td>
                            <p id="edit"><a href="managePhotoCategory.php?category_id=<?php echo $this->_tpl_vars['scValue']['record']['photo_category_id']; ?>
&amp;start=<?php echo $this->_tpl_vars['myobj']->getFormField('start'); ?>
"><?php echo $this->_tpl_vars['LANG']['managephotocategory_edit']; ?>
</a>
                            </p>
                            <p>
                            <a href="managePhotoCategory.php?category_id=<?php echo $this->_tpl_vars['scValue']['record']['photo_category_id']; ?>
&amp;opt=sub"><?php echo $this->_tpl_vars['LANG']['managephotosubgenrelink']; ?>
</a>
                            </p>
                        </td>
                    </tr>
...
" >
                                <option value="Enable"><?php echo $this->_tpl_vars['LANG']['managephotocategory_action_enable']; ?>
</option>
                                <option value="Disable"><?php echo $this->_tpl_vars['LANG']['managephotocategory_action_disable']; ?>
</option>
                                <option value="Delete"><?php echo $this->_tpl_vars['LANG']['managephotocategory_action_delete']; ?>
</option>
                            </select>
                            <input type="button" class="clsSubmitButton" name="action_submit" id="action_submit" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" value="<?php echo $this->_tpl_vars['LANG']['managephotocategory_submit']; ?>
" onClick="if(getMultiCheckBoxValue('selFormCategory', 'check_all', '<?php echo $this->_tpl_vars['LANG']['managephotocategory_err_tip_select_category']; ?>
', 'dAltMlti', -25, -290)) <?php echo ' { '; ?>
 Confirmation('selMsgConfirm', 'msgConfirmform', Array('category_ids', 'action', 'confirmMessage'), Array(multiCheckValue, document.selFormCategory.photo_options.value, '<?php echo $this->_tpl_vars['LANG']['managephotocategory_confirm_message']; ?>
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <?php else: ?>
                <div id="selMsgAlert">
                    <p><?php echo $this->_tpl_vars['LANG']['managephotocategory_no_category']; ?>
</td>
                </div>
            <?php endif; ?>
        </div>
		...
		<p class="clsPageLink" ><?php echo $this->_tpl_vars['LANG']['managephotosubcategorytitle']; ?>
</p>
		<p class="clsPageLink"><a href="<?php echo $this->_tpl_vars['myobj']->getCurrentUrl(false); ?>
"><?php echo $this->_tpl_vars['LANG']['managephotocategory_back_to_main']; ?>
</a></p>
...
"><?php echo $this->_tpl_vars['myobj']->displayCompulsoryIcon(); ?>
<label for="sub_category"><?php echo $this->_tpl_vars['LANG']['managephotosubcategory_subcategory_name']; ?>
</label></td>
                    <td class="<?php echo $this->_tpl_vars['myobj']->getCSSFormFieldCellClass('sub_category'); ?>
">
                        <input type="text" class="clsTextBox" maxlength="<?php echo $this->_tpl_vars['CFG']['admin']['photos']['category_accept_max_length']; ?>
...
">
                    <label for="sub_category_image"><?php echo $this->_tpl_vars['LANG']['managephotosubcategory_subcategory_image']; ?>
...
" />
                        ...
                        <?php if ($this->_tpl_vars['myobj']->getFormField('sub_category_id') && $this->_tpl_vars['myobj']->getFormField('photo_category_ext') != ''): ?>
                            <img src="<?php echo $this->_tpl_vars['myobj']->sub_category_image; ?>
"/><br/>
                            <a href="javascript:void(0);" onclick="return Confirmation('selMsgConfirmSub', 'msgConfirmformSub',Array('action', 'confirmMessageSub'), Array('delete_subcategory_image', '<?php echo $this->_tpl_vars['LANG']['managephotocategory_image_delete_confirmation']; ?>
'), Array('value', 'innerHTML'), -100, -500);"><?php echo $this->_tpl_vars['LANG']['managephotocategory_image_delete']; ?>
</a>
                        <?php endif; ?>
                    	<?php if ($this->_tpl_vars['myobj']->getFormField('photo_category_ext') == '' && $this->_tpl_vars['myobj']->getFormField('sub_category_id')): ?>
                        	<img src="<?php echo $this->_tpl_vars['CFG']['site']['url']; ?>
design/templates/<?php echo $this->_tpl_vars['CFG']['html']['template']['default']; ?>
/admin/images/<?php echo $this->_tpl_vars['CFG']['html']['stylesheet']['screen']['default']; ?>
...
" />
            <input type="hidden" id="photo_category_ext" name="photo_category_ext" value="<?php echo $this->_tpl_vars['myobj']->getFormField('photo_category_ext'); ?>
" />
...
" onClick="CheckAll(document.selFormSubCategory.name, document.selFormSubCategory.check_all.name)"/></th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_subcategory_name']; ?>
</th>
                        <th><?php echo $this->_tpl_vars['LANG']['managephotocategory_date_added']; ?>
</th>
                        <th>&nbsp;</th>
...
?>
                    <tr>
                        <td class="clsAlignCenter clsSelectAllItems"><input type="checkbox" class="clsCheckRadio" name="category_ids[]" value="<?php echo $this->_tpl_vars['pscValue']['record']['photo_category_id']; ?>
" tabindex="<?php echo smartyTabIndex(array(), $this);?>
" <?php echo $this->_tpl_vars['pscValue']['checked']; ?>
 onClick="disableHeading('flaggedForm');"/></td>
                        <td>
                            <p id="categoryName"><?php echo $this->_tpl_vars['pscValue']['record']['photo_category_name']; ?>
</p>
                        </td>
                        <td class="clsSmallWidth"><?php echo $this->_tpl_vars['pscValue']['record']['date_added']; ?>
</td>
                        <td class="clsSmallWidth"><p id="edit"><a href="managePhotoCategory.php?category_id=<?php echo $this->_tpl_vars['myobj']->getFormField('category_id'); ?>
&amp;sub_category_id=<?php echo $this->_tpl_vars['pscValue']['record']['photo_category_id']; ?>
&amp;opt=subedit"><?php echo $this->_tpl_vars['LANG']['managephotocategory_edit']; ?>
</a></p></td>
                    </tr>
                <?php endforeach; endif; unset($_from); ?>
                    <tr>
                        <td colspan="4">
                            ...
                            <input type="button" class="clsSubmitButton" value="<?php echo $this->_tpl_vars['LANG']['managephotocategory_action_delete']; ?>
" onClick="if(getMultiCheckBoxValue('selFormSubCategory', 'check_all', '<?php echo $this->_tpl_vars['LANG']['managephotocategory_err_tip_select_category']; ?>
...
', '<?php echo $this->_tpl_vars['LANG']['managephotocategory_confirm_message']; ?>
...
" />
            ...
            <?php else: ?>
                <div id="selMsgAlert">
                    <p><?php echo $this->_tpl_vars['LANG']['managephotocategory_no_sub_category']; ?>
</td>
                </div>
            <?php endif; ?>
        <?php endif; ?>
