...
:</span>
		      ...
		      <div class="clsViewVideoLeft">
                           ...
                           <!--Social icons by Abror Ahmedov Start -->
              <noindex>
              <div id="likebuttons">
              <script type="text/javascript" src="http://vk.com/js/api/share.js?11" charset="windows-1251"></script>
              <script type="text/javascript" src="https://apis.google.com/js/plusone.js">{lang: 'ru'}</script>
              <table><tr>
<td><div id="fb-root"></div><script>(function(d, s, id) {var js, fjs = d.getElementsByTagName(s)[0];if (d.getElementById(id)) return;js = d.createElement(s); js.id = id;js.src = "//connect.facebook.net/ru_RU/all.js#xfbml=1";fjs.parentNode.insertBefore(js, fjs);}(document, 'script', 'facebook-jssdk'));</script><div class="fb-like" data-href="https://mediabox.uz/" data-send="false" data-layout="button_count" data-width="140" data-show-faces="true"></div>&nbsp;&nbsp;</td>
<td><script type="text/javascript">document.write(VK.Share.button(false,{type: "round", text: "Рассказать"}));</script></td>
<td>&nbsp;&nbsp;<a rel="nofollow" href="https://twitter.com/share" class="twitter-share-button" data-url="https://mediabox.uz/" data-lang="ru">Твитнуть</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></td>
<td width="250"><a rel="nofollow" target="_blank" class="mrc__plugin_uber_like_button" href="http://connect.mail.ru/share?share_url=http%3A%2F%2Fmediabox.uz%2F" data-mrc-config="{'type' : 'button', 'caption-mm' : '1', 'caption-ok' : '1', 'counter' : 'true', 'text' : 'true', 'width' : '100%'}">Нравится</a><script src="http://cdn.connect.mail.ru/js/loader.js" type="text/javascript" charset="UTF-8"></script></td>
<td><div class="g-plusone" data-size="small" data-href="mediabox.uz"></div></td>
</tr></table></div>
</noindex>
<!--Social icons END -->
...
"><span><?php echo ((is_array($_tmp=$this->_tpl_vars['LANG']['favorites'])) ? $this->_run_mod_handler('capitalize', true, $_tmp, true) : smarty_modifier_capitalize($_tmp, true)); ?>
                        ...
                        <div id="clsMsgDisplay" class="clsDisplayNone clsFeaturedContent clsAddErrorMsg">
                               ...
                               <?php /*?> odl social icons by Abror Ahmedov
							   <div class="clsRightUrl">
