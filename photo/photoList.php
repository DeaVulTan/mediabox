...
$memberPhotoListAccessPages = array('myphotos','myfavoritephotos', 'myrecentlyviewedphoto', 'myalbumphotolist', 'myplaylist');
if ((isset($_REQUEST['pg']) AND in_array($_REQUEST['pg'],$memberPhotoListAccessPages)) || (isset($_REQUEST['mem_auth']) && $_REQUEST['mem_auth'] == 'true'))
{
...
$CFG['admin']['light_window_page'] = true;
require_once('general/photoList.php');
?>