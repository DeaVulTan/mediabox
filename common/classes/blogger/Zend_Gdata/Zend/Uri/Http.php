...
class Zend_Uri_Http extends Zend_Uri
{
    ...
    protected function __construct($scheme, $schemeSpecific = '')
    {
        ...
        // Validate the URI
        if (!$this->valid()) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Invalid URI supplied');
        }
    }
    ...
    protected function _parseUri($schemeSpecific)
    {
        ...
        if ($status === false) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Internal error: scheme-specific decomposition failed');
        }
        ...
        if ($status === false) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Internal error: authority decomposition failed');
        }
    ...
    {
        if (!$this->valid()) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('One or more parts of the URI are invalid');
        }
    ...
    public function validateUsername($username = null)
    {
        ...
        if ($status === false) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Internal error: username validation failed');
        }
    ...
    public function setUsername($username)
    {
        if (!$this->validateUsername($username)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception("Username \"$username\" is not a valid HTTP username");
        }
    ...
    public function validatePassword($password = null)
    {
        ...
        if ($status === false) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Internal error: password validation failed.');
        }
        return $status == 1;
    }
    ...
    public function setPassword($password)
    {
        if (!$this->validatePassword($password)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception("Password \"$password\" is not a valid HTTP password.");
        }
    ...
    public function setHost($host)
    {
        if (!$this->validateHost($host)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception("Host \"$host\" is not a valid HTTP host");
        }
        $oldHost = $this->_host;
        $this->_host = $host;
        return $oldHost;
    ...
    public function setPort($port)
    {
        if (!$this->validatePort($port)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception("Port \"$port\" is not a valid HTTP port.");
        }
        $oldPort = $this->_port;
        $this->_port = $port;
        return $oldPort;
    ...
    public function validatePath($path = null)
    {
        ...
        if ($status === false) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Internal error: path validation failed');
        }
    ...
    public function setPath($path)
    {
        if (!$this->validatePath($path)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception("Path \"$path\" is not a valid HTTP path");
        }
        $oldPath = $this->_path;
        $this->_path = $path;
        return $oldPath;
    ...
    public function validateQuery($query = null)
    {
        ...
        if ($status === false) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Internal error: query validation failed');
        }
    ...
    protected function _parseQuery($query)
    {
        ...
        if ($this->validateQuery($query)) {
                ...
                return false;//commented by selvaraj//throw new Zend_Uri_Exception("'$query' is not a valid query string");
        }
        return $query;
    }
    ...
    public function validateFragment($fragment = null)
    {
        ...
        if ($status === false) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Internal error: fragment validation failed');
        }
    ...
    public function setFragment($fragment)
    {
        if (!$this->validateFragment($fragment)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception("Fragment \"$fragment\" is not a valid HTTP fragment");
        }
