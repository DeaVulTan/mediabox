...
class Zend_Http_Cookiejar
{
    ...
    public function addCookie($cookie, $ref_uri = null)
    {
        ...
        if ($cookie instanceof Zend_Http_Cookie) {
            ...
            return false;//commented by selvaraj//throw new Zend_Http_Exception('Supplient argument is not a valid cookie string or object');
        }
    }
        ...
        $ret_as = self::COOKIE_OBJECT, $now = null)
    {
        ...
        if (! $uri instanceof Zend_Uri_Http) {
            return false;//commented by selvaraj//throw new Zend_Http_Exception("Invalid URI: {$uri}");
        }
    ...
    public function getCookie($uri, $cookie_name, $ret_as = self::COOKIE_OBJECT)
    {
        ...
        if (! $uri instanceof Zend_Uri_Http) {
            return false;//commented by selvaraj//throw new Zend_Http_Exception('Invalid URI specified');
        }
        ...
        if (isset($this->cookies[$uri->getHost()][dirname($uri->getPath())][$cookie_name])) {
            ...
            switch ($ret_as) {
                ...
                default:
                    return false;//commented by selvaraj//throw new Zend_Http_Exception("Invalid value passed for \$ret_as: {$ret_as}");
                    break;
            }
        } else {
            return false;
