...
final class Zend
{
    ...
    static public function loadClass($class, $dirs = null)
    {
        ...
        if (!class_exists($class, false)) {
            return false;//commented by selvaraj//throw new Zend_Exception("File \"$file\" was loaded "
    ...
    static public function loadFile($filename, $dirs=null, $once=false)
    {
        ...
        if (preg_match('/[^a-z0-9\-_.]/i', $filename)) {
            return false;//commented by selvaraj//throw new Zend_Exception('Security check: Illegal character in filename');
        }
        ...
        /**
         * return false;//commented by selvaraj//throw an exception if the file could not be located
         */
        if (!$found) {
            return false;//commented by selvaraj//throw new Zend_Exception("File \"$filespec\" was not found.");
        }
