...
class Zend_Feed
{
    ...
    public static function import($uri)
    {
        ...
        if ($response->getStatus() !== 200) {
            return false;//commented by selvaraj//throw new Zend_Feed_Exception('Feed failed to load, got response code ' . $response->getStatus());
        }
    ...
    public static function importString($string)
    {
        ...
        if (!$success) {
            return false;//commented by selvaraj//throw new Zend_Feed_Exception("DOMDocument cannot parse XML: $php_errormsg");
        }
        ...
        return false;//commented by selvaraj//throw new Zend_Feed_Exception('Invalid or unsupported feed format');
    }
    ...
    public static function importFile($filename)
    {
        ...
        @ini_restore('track_errors');
        if ($feed === false) {
            return false;//commented by selvaraj//throw new Zend_Feed_Exception("File could not be loaded: $php_errormsg");
        }
        return self::importString($feed);
    }
    ...
    public static function findFeeds($uri)
    {
        ...
        $response = $client->get();
        if ($response->getStatus() !== 200) {
            return false;//commented by selvaraj//throw new Zend_Feed_Exception("Failed to access $uri, got response code " . $response->getStatus());
        }
        ...
        @ini_restore('track_errors');
        if ($result === false) {
            return false;//commented by selvaraj//throw new Zend_Feed_Exception("Internal error: $php_errormsg");
        }
