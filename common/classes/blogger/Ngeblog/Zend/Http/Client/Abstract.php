...
abstract class Zend_Http_Client_Abstract
{
    ...
    public function setUri($uri)
    {
        ...
        if ($uri instanceof Zend_Uri_Http) {
            ...
            return false;//commented by selvaraj//throw new Zend_Http_Exception('Passed parameter is not a valid HTTP URI.');
        }
    ...
    public function setMethod($method = self::METHOD_GET)
    {
        ...
        if (! defined('self::METHOD_' . $method)) {
            return false;//commented by selvaraj//throw new Zend_Http_Exception("'{$method}' is not a valid HTTP request method.");
        }
    ...
    public function setHeaders($name, $value = null, $override = true)
    {
        ...
        if (is_array($name)) {
            ...
            if (! preg_match('/^[A-Za-z0-9-]+$/', $name)) {
                return false;//commented by selvaraj//throw new Zend_Http_Exception("{$name} is not a valid HTTP header name");
            }
    ...
    public function request($method = null)
    {
        if (! $this->uri instanceof Zend_Uri_Http)
            return false;//commented by selvaraj//throw new Zend_Http_Exception("No valid URI has been passed to the client");
    ...
    static public function validateHeaders($headers = array())
    {
        ...
        if (is_array($headers)) {
            ...
            return false;//commented by selvaraj//throw new Zend_Http_Exception("Parameter must be an array of header lines.");
    ...
    protected function _setParameter($type, $name, $value, $override = true)
    {
        ...
        switch ($type) {
            ...
            case 'post':
                ...
                break;
            default:
                return false;//commented by selvaraj//throw new Zend_Http_Exception("Trying to set unknown parameter type: '{$type}'");
        }
