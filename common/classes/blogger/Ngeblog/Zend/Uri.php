...
abstract class Zend_Uri
{
    ...
    static public function factory($uri = 'http')
    {
        ...
        if (!strlen($scheme)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('An empty string was supplied for the scheme');
        }

        // Security check: $scheme is used to load a class file, so only alphanumerics are allowed.
        if (!ctype_alnum($scheme)) {
            return false;//commented by selvaraj//throw new Zend_Uri_Exception('Illegal scheme supplied, only alphanumeric characters are permitted');
        }
        ...
        switch ($scheme) {
            ...
            default:
                                return false;//commented by selvaraj//throw new Zend_Uri_Exception("Scheme \"$scheme\" is not supported");
        }
