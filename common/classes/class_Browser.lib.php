<?php
	...
	class Browser {
		 ...
		 */
		public function setVersion($version) { $this->_version = preg_replace('/[^A-Za-z0-9.]/','',$version); }
		/**
		 * The version of AOL.
		 ...
		 */
		public function setAolVersion($version) { $this->_aol_version = preg_replace('/[^A-Za-z0-9.]/','',$version); }
		/**
		...
		protected function checkForAol() {
			...
			if( eregi("AOL", $this->_agent) ) {
				...
				$this->setAol(true);
				$this->setAolVersion(preg_replace('/[^A-Za-z0-9.]/', '', $aversion[1]));
